...
.channel-ul {
  ...
  .channel-a {
    ...
    .channel-bg {
      ...
      width: 10.875rem;
      height: 11.25rem;
      background: url(../../../../public/img/index/channel1.jpg) no-repeat
        center;
      ...
      .channel-pause {
        ...
        width: 2.125rem;
        height: 2.125rem;
        background: url(../../../../public/img/index/ic_pause_black.png)
          no-repeat;
        background-size: 100%;
        top: 8.5625rem;
        left: 0.6875rem;
      ...
      .channel-play {
        ...
        width: 2.125rem;
        height: 2.125rem;
        background: url(../../../../public/img/index/ic_play_black.png)
          no-repeat;
        background-size: 100%;
        top: 8.5625rem;
        left: 0.6875rem;
